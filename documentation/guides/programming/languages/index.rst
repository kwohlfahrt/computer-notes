...
`Python <CPython_>`_ is an interpreted, dynamically typed programming language.
...
`Haskell <haskell_>`_ is a compiled, statically typed, functional programming
language. The web-site includes a simple haskell interpreter.

Rust
----

`Rust <rust_>`_ is a compiled, statically typed programming language. It is
